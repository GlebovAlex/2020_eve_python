...
'''
from the MainScreen -- init method
# self.loves_Running_Jumping = driver.find_element_by_xpath(Locators.page1_Qtn2_xpath)
# self.Next_Screen1 = driver.find_element_by_xpath(Locators.page1_Next_xpath)
# self.Next_Screen1 = driver.find_element_by_xpath(Locators.page1_Next_xpath)
# self.Next_Screen2 = driver.find_element_by_xpath(Locators.page2_Next_xpath)
# self.practice_for_hours = driver.find_element_by_xpath(Locators.page3_Qtn1_xpath)
# self.Next_Screen3 = driver.find_element_by_xpath(Locators.page3_Next_xpath)
